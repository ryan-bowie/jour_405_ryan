...
Had trouble loading the tidyverse library. It wasnt initally installed so I looked it up and Google said to install it before using the library tag. R asked me to restart multiple times before I eventually just hit cancel. I have no idea if I messed something up or not.
