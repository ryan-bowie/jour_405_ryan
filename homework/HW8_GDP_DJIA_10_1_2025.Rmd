...
GDP_data |> 
  ...
  labs(title = "Correlation of GDP and DJIA")
...
Yes, a strong correlation is shown between GDP and DJIA because all the dots are close together along the regression line. The scatterplot also shows a positive correlation because the line is sloping upward from left to right. You can also tell by the correlation being 0.953 that it is a positive strong correlation between the two.
