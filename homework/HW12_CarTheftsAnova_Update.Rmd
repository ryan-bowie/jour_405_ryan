...
The chart is showing how car thefts were relatively gradual from 2017-2022, until dramatically spiking in 2023 and then decreasing in 2024. A more active title is Thefts Lower After 2023 Spike. A lede could be "Car theft rates sharply decreased following a massive spike in 2023."
...
- **Null Hypothesis (H0)**:   there is no real difference between the three periods

- **Alternative Hypothesis (H1)**: there is a real difference between the three periods
...
Yes there are real differences. The ANOVA test shows that theft rates aren't the same across the three time periods. Also, the p-value is small, indicating the result is statiscally significant. 
...
The Tukey test shows that all three periods are significantly different from each other. All of the pairs have a p-value of 0, meaning the spike year had much higher theft rates than both the pre-spike and post-spike periods, and the post-spike period is also significantly higher than the pre-spike period. The increase in theft was real, even after the spike year ended, thft was still relatively high.

Headline: Car Thefts Stay High Following 2023 Spike

Lede: New data revealed that car thefts reached an all-time high in 2023 and have stayed on the rise compared to the years prior to the spike. 
