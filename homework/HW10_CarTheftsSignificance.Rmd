...
Yes, an overall trend is that there has been a steady decrease of car thefts over the course of roughly two years. However, there seems to be a spike around January and February of 2024 where thefts increased before leveling off and then decreasing again.
...
theft_summary
```
#Ryan Bowie: Code wont run correctly, not displaying the proper variables. I inserted the SD of 96.7, but no other variables show up.
...
The 95% confidence interval shows that we can be 95% confident that the average number of car thefts per month is somewhere near the mean of 460.4.

- What figure(s) accurately reflects the number of car thefts in a typical month? **WRITE ANSWER HERE:**

The sample mean of 460.4 which means there's typically around 460.4 car thefts per month.
...
Car Thefts Continue to Decline Despite 2024 Spike.
...
I feel like I did this wrong, but according to this chart we cannot reject the null hypothesis as both periods are exactly the same.
...
I would change my headline to "Car Thefts Are An Ongoing Issue in X City". I would tell my editor to include this chart showing that the average number of car thefts has been consistent regardless of the time of year. I would expect to be asked "did you do the math correctly?" to which I would reply, "I think so, but I'll ask for a second opinion to make sure it is correct before publishing."
