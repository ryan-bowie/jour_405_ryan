...
MoE:
52% support, sample size 100, MoE is 10, 62% and 42% are the plus/minus
53% support, sample size 800, MoE is 3.54, 56.5% and 49.5% are the plus/minus
55% support, sample size 400, MoE is 5, 60% and 50% are the plus/minus
...
Yes, given the two polls with the largest sample sizes yield results at or slightly under 50% on the lowest ends and well above 50% on the high ends, one could assume that the there is a slight majority that supports the new city policy. Also all the base percentage numbers are over 50% as well, indicating a slight majority.
...
Statistics show that the average prices of homes will increase with the installation of the new transit line. 

The average price of a home before the transit line installation was $285,000. After the transit line was installed, the average price of a home rose to $304,500.

The rise is price stems from more willingness from incoming residents to pay a premium for convenience. The transit line will allow higher ease of transportation to shopping centers, parks and universities.
