...
There seem to be consistent spikes and dips from the beginning of 2022 until the beginning of 2023. Overall there seems to be a higher number of 911 calls from the beginning of 2022 until mid-2022. The mean of 10.44 is consistent throughoout the entire year with the spikes and dips evening out the overall amount of calls. 
```{r daily-calls-plot}
...
Looking at the data during Task 3, despite irregularities in the spikes and dips on the graph, the graph and the data displayed look fairly consistent throughout the entire time period. However, now that I can see the z-scores for the unusual entries, I can tell there are obvious outliers given the z-scores for all the above entries are outside of the -2 to +2 threshhold of being normal values.
```{r plot-unusual-days}
...
**Write your answer here**
Saturday has the highest average amount of calls, meaning that it is likely skewed a bit by higher values from all Saturdays throughout the year. 
...
One angle could be that 911 calls were coming in at a higher volume during the spring months and then dropping in the fall/winter months.

I could also say that Saturdays have been the days in which the volume of calls has consistently been the highest. I could also state that there were 11 days in which the volume of calls was unusually high and 7 days in which the volume of calls was unusually low. The next steps would be to find a way to write these findings in a journalistic way without it being too statistical. I would cross-reference my findings with someone in the data department to make sure that everything I'm seeing is correct before reporting to my editor.
