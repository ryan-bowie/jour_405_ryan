...
The people in the survey samples could be from different areas outside of the general population that are more or less educated. Some college and College could be over or underrepresented according to type of degree. Someone with only an Associate's degree might consider themselves in the College bracket rather than the Some college bracket. Also, some people with an Associate's degree that are also pursing a Bachelor's degree might put themselves in the Some college bracket instead of College bracket.
...
Higher Educated People Are More Sure of Who They Will Vote For, studies show.
...
The "College" and "Some college" categories barely changed, but the "High school or less" group showed the largest change, slightly decreasing over 2 percentage points in the "Yes" category and slightly increasing by 1-2 percentage points in the "No" and "Unsure" categories.

2. Why might the weighted results be considered more accurate than the unweighted results?

**Write your ANSWER HERE**

Because the weighted results are adjusted to properly account for what the population represents.
...
The "High school or less" group shows the largest differences.
...
**Write your ANSWER HERE**
Because a survey can yield very different results if a weight is placed on it or not. These small differences are very important in terms of elections given how close they usually are in percentage.

2. How might the differences between weighted and unweighted results affect how you would report on this data?

**Write your ANSWER HERE**

I would be more willing to trust the weighted results since they are more indicative of the population as a whole. Regardless of if I used the weighted or unweighted results, I would indicate it in the story so the reader understands what version of the results they are looking at.
...
I would want to know the exact parameters on how these weights were placed. Are these people in the "High school or less" categories mainly high school graduates, GED recipients or dropouts?
