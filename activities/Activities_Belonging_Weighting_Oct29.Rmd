...
Under the section of "Coding and Demographic Variables," the appendix states that since there wasn't enough respondents for certain demographics, so they were grouped into one category. Also, the survey stated over half of the respondents identified as female and only 38% of men responded. This is not indicative of the population of men, which stands at 50%. I wonder why it was so hard to get more men to respond to the survey?
...
If a respondent has a weight of 0.23, that means they are fairly represented well, if they have a weight of 3.04, that means they are underrepresented.

3. Why might some respondents be weighted more heavily than others? **Write your answer here:**
If the surveyor is unable to get responses from a certain population, they can weight them accordingly so that the data represents them better.
...
The rarely/never category of voters shows the largest difference of over 3.5 percentage points. 

2. How might these differences affect reporting on likely voter turnout? **Write your answer here:**
A negative difference of 3.6 percentage points, in terms of voters who rarely/never vote can mean that the voter turnout for that group is calculated to be less than what the unweighted is. Which makes sense considering the category is rarely/never.
...
These differences exist to get as accurate of a reading as possible to figure out what turnout will be. Since the difference between unweighted and weighted is -3.6, it means the rarely/never category is overrepresented and it was weighted according to the total population.
